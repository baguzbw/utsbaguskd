              ...
              <div class="card shadow-2-strong" style="border-radius: 1rem">
                <div class="card-body p-5 text-center">
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" id="typeEmailX-2" class="form-control form-control-lg" placeholder="Masukkan Username" name="username" />
                  ...
                  <button class="btn btn-secondary btn-lg btn-block" type="submit" name="login">Login</button>
                  <div class="text-center mt-2"><a href="register.php">Mahasiswa Baru</a></div>
                </div>
              </div>
            </div>
          </div>
